...
<div class="container">
  <div class="top-navbar header b-b"> <a data-original-title="Toggle navigation" class="toggle-side-nav pull-left" href="#"><i class="icon-reorder"></i> </a>
    <div class="brand pull-left"> <a href="index.html"><img src="<?php echo base_url()?>asset/images/gapura.png" width="147" height="33"></a></div>
    <ul class="nav navbar-nav navbar-right  hidden-xs">
      ...
      <li class="dropdown"> <a data-toggle="dropdown" class="dropdown-toggle" href="#"> <i class="icon-envelope"></i> <span class="badge">1</span> </a>
        <ul class="dropdown-menu extended notification">
          ...
          <li> <a href="#"> <span class="photo"> <img src="<?php echo base_url()?>asset/images/profile.png" width="34" height="34"></span> <span class="subject"> <span class="from">John Doe</span> <span class="time">Just Now</span> </span> <span class="text"> Consetetur sadipscing elitr...</span> </a> </li>
          <li> <a href="#"> <span class="photo"><img src="<?php echo base_url()?>asset/images/profile.png" width="34" height="34"></span> <span class="subject"> <span class="from">John Doe</span> <span class="time">35 mins</span> </span> <span class="text"> Sed diam nonumy... </span> </a> </li>
          <li> <a href="#"> <span class="photo"><img src="<?php echo base_url()?>asset/images/profile.png" width="34" height="34"></span> <span class="subject"> <span class="from">John Doe</span> <span class="time">5 hours</span> </span> <span class="text"> No sea takimata sanctus... </span> </a> </li>
    ...
    <div class="content container">
      ...
      <div class="row">
        ...
        <div class="col-lg-6">
          ...
          <div class="widget-container">
            <div class="panel-body"> <a class="thumb pull-left m-r" href="#"> <img class="img-circle" src="<?php echo base_url()?>asset/images/user.jpg"></a>
          ...
          <div class="widget">
            ...
            <div class="widget-content">
              <div class="timeline-messages"> 
                <!-- Comment -->
                <div class="msg-time-chat"> <a href="#" class="message-img"><img class="avatar" src="<?php echo base_url()?>asset/images/avatar.jpg" alt=""></a>
              ...
              <div class="widget widget-tabs">
                ...
                <div class="tab-content">
                  <div class="tab-pane clearfix active" id="stats">
                    ...
                    <ul class="users-list">
                      <li> <img class="pull-left img-circle" alt="" src="<?php echo base_url()?>asset/images/img1.jpg">
                        <div class="user-info">
...
<script type="text/javascript" src="<?php echo base_url()?>asset/js/smooth-sliding-menu.js"></script> 
<script class="include" type="text/javascript" src="<?php echo base_url()?>asset/javascript/jquery191.min.js"></script> 
<script class="include" type="text/javascript" src="<?php echo base_url()?>asset/javascript/jquery.jqplot.min.js"></script> 

<script src="<?php echo base_url()?>asset/assets/sparkline/jquery.sparkline.js" type="text/javascript"></script>
<script src="<?php echo base_url()?>asset/assets/sparkline/jquery.customSelect.min.js" ></script>
<script src="<?php echo base_url()?>asset/assets/sparkline/sparkline-chart.js"></script>
<script src="<?php echo base_url()?>asset/assets/sparkline/easy-pie-chart.js"></script>
...
<div class="demo_changer active" style="right: 0px;">
  ...
  <div class="form_holder">
    <div class="predefined_styles"> <a class="styleswitch" rel="a" href="#"><img alt="" src="<?php echo base_url()?>asset/images/a.jpg"></a> 
	<a class="styleswitch" rel="b" href="#"><img alt="" src="<?php echo base_url()?>asset/images/b.jpg"></a> 
	<a class="styleswitch" rel="c" href="#"><img alt="" src="<?php echo base_url()?>asset/images/c.jpg"></a> 
	<a class="styleswitch" rel="d" href="#"><img alt="" src="<?php echo base_url()?>asset/images/d.jpg"></a> 
	<a class="styleswitch" rel="e" href="#"><img alt="" src="<?php echo base_url()?>asset/images/e.jpg"></a> 
	<a class="styleswitch" rel="f" href="#"><img alt="" src="<?php echo base_url()?>asset/images/f.jpg"></a> <a class="styleswitch" rel="g" href="#"><img alt="" src="images/g.jpg"></a> <a class="styleswitch" rel="h" href="#"><img alt="" src="<?php echo base_url()?>asset/images/h.jpg"></a> <a class="styleswitch" rel="i" href="#"><img alt="" src="<?php echo base_url()?>asset/images/i.jpg"></a> <a class="styleswitch" rel="j" href="#"><img alt="" src="<?php echo base_url()?>asset/images/j.jpg"></a> </div>
  </div>
</div>
start-->
<!--switcher html end--> 
